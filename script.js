document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        es: {
            title: "Top Cleaning Services in Massachusetts | SGM Clean Solutions",
            inicio: "Inicio",
            nosotros: "Nosotros",
            servicios: "Servicios",
            ofertas: "Ofertas",
            ...
            heroTitle: "Expertos en Mantenimiento y Limpieza de Pisos en Massachusetts",
            heroDescription: "Soluciones profesionales para todo tipo de superficies en Massachusetts",
            heroButton: "Tips de Limpieza Gratis",
            aboutTitle: "Sobre Nosotros",
            servicesTitle: "Nuestros Servicios en Massachusetts",
        ...
        en: {
            ...
            cotizacion: "Quote",
            heroTitle: "Experts in Floor Maintenance and Cleaning in Massachusetts",
            heroDescription: "Professional solutions for all types of surfaces in Massachusetts",
            heroButton: "Free Cleaning Tips",
            aboutTitle: "About Us",
            servicesTitle: "Our Services in Massachusetts",
        ...
        tipsButton.addEventListener('click', function(e) {
            ...
            if (typeof gtag !== 'undefined') {
                gtag('event', 'click', {
                    ...
                    'event_label': 'cleaning-tips-button'
                });
            }
